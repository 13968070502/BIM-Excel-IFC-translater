...
with open('STEP-file.ifc', 'w') as f:
    ...
    f.write(file_description + representation_type + apostrophe + implementation_level + apostrophe + end_row + next_row)
    f.write(file_name + no_value + comma + apostrophe + timestamp + apostrophe + comma + start_argument + author + end_argument + no_value_b + comma + no_value + comma + no_value + comma + no_value + end_row + next_row)

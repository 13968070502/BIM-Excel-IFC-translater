...
"""Inheritance path of class IfcPipeSegment"""

# IfcRoot -> IfcObjectDefinition -> IfcObject -> IfcProduct  -> IfcElement ->
# IfcDistributionElement -> IfcDistributionFlowElement -> IfcFlowSegment -> IfcPipeSegment
...
data_IfcPipeSegment = IfcPipeSegment('1234567890123456789012', 'Pipe', 'Heating', 'Flow Element', 'IfcFlowSegment',
                                     '0.0.0', 'No')
